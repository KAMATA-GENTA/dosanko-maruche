...
public enum Region {
	...
	Sapporo(1, "札幌", "北海道の中心都市です。市町村の魅力度ランキング調査でも毎年上位にランクインしていて、海鮮だけでなく、スープカレーなども有名です", "Sapporo.png",
			Character.SapporoChan, "#dff5ff"), Hakodate(2, "函館", "夜景と海鮮が有名です", "Hakodate.png", Character.HakodateChan,
					"#1b2b52"), Kitami(3, "北見", "テーマパークがあります", "Kitami.png", Character.KitamiChan, "#fff1cc"), Wakkanai(
							...
							Character.WakkanaiChan, "#d9f2ff"), Otaru(5, "小樽",
									...
									Character.OtaruChan, "#d6f0ff"), Obihiro(6, "帯広", "豚丼が有名です", "Obihiro.png",
