...
public class RegionController {
	...
	public String showRegion(
		...
		model.addAttribute("products", productService.getProductsByRegionId(region.getRegion_id()));
	...
	@GetMapping("/{regionName}/category/{categoryId}")
	public String showRegionCategory(
			@PathVariable String regionName,
